...
if(!file_exists(WB_PATH .'/modules/imagegallery/languages/'.LANGUAGE .'.php')) {
	// no module language file exists for the language set by the user, include default module language file EN.php
	require_once(WB_PATH .'/modules/imagegallery/languages/EN.php');
} else {
	// a module language file exists for the language defined by the user, load it
	require_once(WB_PATH .'/modules/imagegallery/languages/'.LANGUAGE .'.php');
}

// check if backend.css file needs to be included into the <body></body> of modify.php
if(!method_exists($admin, 'register_backend_modfiles') && file_exists(WB_PATH ."/modules/imagegallery/backend.css")) {
	echo '<style type="text/css">';
	include(WB_PATH .'/modules/imagegallery/backend.css');
	echo "\n</style>\n";
}
...
<form name="modify" action="<?php echo WB_URL; ?>/modules/imagegallery/save.php" method="post" >
...
<fieldset class="gallery">
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['TITLE_TEXT']; ?>:<br /></div>
	<div class="gallery_setting_value"><input type="text" name="titletext" value="<?php echo $settings['titletext']; ?>" /><br /></div>
	
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['SHOW_TITLE']; ?>:<br /></div>
...
<fieldset class="gallery">
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['PICDIR']; ?>:<br /></div>
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['INCLUDE_SUBDIRS']; ?>:<br /></div>
...
<fieldset class="gallery">
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['THUMBDIR']; ?>:<br /></div>
	<div class="gallery_setting_value"><input type="text" name="thumbdir" value="<?php echo $settings['thumbdir']; ?>" /><br /></div>

	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['THUMBS_BACKGROUND']; ?>:<br /></div>
	<div class="gallery_setting_value"><input type="text" name="bg" value="<?php echo $settings['bg']; ?>" /><br /></div>

	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['MAXPICS']; ?>:<br /></div>
	<div class="gallery_setting_value"><input type="text" name="maxpics" value="<?php echo $settings['maxpics']; ?>" /><br /></div>

	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['THUMBSIZE']; ?>:<br /></div>
...
<fieldset class="gallery">
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['MAXWIDTH']; ?>:<br /></div>
	<div class="gallery_setting_value"><input type="text" name="maxwidth" value="<?php echo $settings['maxwidth']; ?>" /> px<br /></div>
	
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['INLINE']; ?>:<br /></div>
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['SHOW_FILE_NAMES']; ?>:<br /></div>
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['SHOW_ORIGINAL']; ?>:<br /></div>
	...
	<div class="gallery_setting_name"><?php echo $MOD_IMAGEGALLERY['SHOW_TEXTLINK']; ?>:<br /></div>
